...
?>
					...
					<table>
						<thead>
							<tr>
								...
								<th class="head-item-price"><span><?php _e('Вес одного товара', 'woocommerce-delivery-notes'); ?></span></th>
								<th class="head-quantity"><span><?php _e('Quantity', 'woocommerce-delivery-notes'); ?></span></th>
								<th class="head-price"><span><?php _e('Вес по количеству', 'woocommerce-delivery-notes'); ?></span></th>
							</tr>
						</thead>
								...
								<?php foreach( $order->get_items() as $item ) : ?>
									...
									<tr>
										...
										<td class="product-item-price">
											<span><?php $productweight = $product->get_weight();
														echo ($productweight == 0 ? '' : $productweight . ' г.'); ?>
											</span>
										</td>
										...
										<td class="product-price">
											<span><?php echo ($productweight == 0 ? '' : ($productweight)*($item->get_quantity()) . ' г.');
											$totalweight = $totalweight + $productweight*($item->get_quantity());
											?>
											</span>
										</td>
									</tr>
						...
						<tfoot>
									<tr>
										<td class="total-name"><span><?php echo 'Всего:'; ?></span></td>
										<td class="total-item-price"></td>
										<td class="total-quantity"></td>
										<td class="total-price"><span><?php echo $totalweight . ' г.'; ?></span></td>
									</tr>
						</tfoot>
					</table>
				...
				<div class="order-notes">
					<?php if( wcdn_has_customer_notes( $order ) ) : ?>
						<h4><?php _e( 'Пожелания клиента', 'woocommerce-delivery-notes' ); ?></h4>
