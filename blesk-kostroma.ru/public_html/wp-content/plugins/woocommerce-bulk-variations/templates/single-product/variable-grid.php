...
<div id="matrix_form">
    ...
    <form id="wholesale_form" action="" class="bulk_variations_form cart matrix" method="post" enctype='multipart/form-data'>
        ...
        <div class="matrix-add-to-cart-wrap">
            <button type="submit" class="single_add_to_cart_button button alt"><?php echo apply_filters( 'single_add_to_cart_text', __( 'Заказать', 'woocommerce' ), 'variable' ); ?></button>
        </div>
                ...
                <div class="summary">
                    ...
                    <ul>
						...
						<?php if ( $variation->get_sku() ) : ?>
                            <li><?php echo "Арт. " . $field_data['variation_data']['sku']; ?></li>
                        <?php endif; ?>
                        <?php if ( $variation->get_weight() ) : ?>
                            <li><?php echo "Вес " . $field_data['variation_data']['weight'] . "г."; ?></li>
						<?php endif; ?>
